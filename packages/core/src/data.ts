...
export interface FHIRCondition {
  ...
  code: {
    coding: Array<{ system: string; code: string; display: string; system2?: string }>;
    text: string;
  };
  subject: { reference: string };
  ...
  entry: [
    ...
    // STEMI with cardiogenic shock: systolic < 90 mmHg
    {
      resource: {
        ...
        referenceRange: [
          { low: { value: 100, unit: "mmHg" }, text: "Cardiogenic shock threshold" },
        ],
      } as FHIRObservation,
    },
          ...
          coding: [
            {
              ...
              code: "I21.09",
              display: "Akuter transmuraler Myokardinfarkt der Vorderwand, als initial bezeichnet",
            },
            {
          ...
          coding: [
            {
              system: "http://snomed.info/sct",
              code: "418425009",
              display: "Adverse reaction to iodinated contrast media",
            },
          ],
  ...
  entry: [
    {
      resource: {
        ...
        meta: {
          versionId: "1",
          lastUpdated: "2024-03-18T02:17:00+01:00",
          profile: ["http://hl7.org/fhir/StructureDefinition/Patient"],
        },
        identifier: [
          {
            ...
            system: "https://klinikum-heidelberg.de/fhir/sid/patientId",
            value: "KHD-2024-019823",
          },
        ],
    ...
    // Surviving Sepsis Campaign 2021: Lactate > 2 → ICU admission, > 4 → mortality risk ++
    {
      resource: {
        ...
        referenceRange: [
          {
            low: { value: 0.5, unit: "mmol/L" },
            high: { value: 2.0, unit: "mmol/L" },
            text: "Normal < 2.0, Shock > 4.0",
          },
        ],
      } as FHIRObservation,
    },
    ...
    // > 0.5 µg/L → bacterial infection, > 2.0 → sepsis, > 10 → septic shock
    {
      resource: {
        ...
        referenceRange: [
          { high: { value: 0.5, unit: "µg/L" }, text: "Sepsis > 2.0, Shock > 10.0" },
        ],
      } as FHIRObservation,
    },
          ...
          coding: [
            {
              system: "http://hl7.org/fhir/sid/icd-10-gm",
              code: "A41.9",
              display: "Sepsis, nicht näher bezeichnet",
            },
            {
              system: "http://hl7.org/fhir/sid/icd-10-gm",
              code: "J18.9",
  ...
  entry: [
    {
      resource: {
        ...
        meta: {
          versionId: "1",
          lastUpdated: "2024-03-21T09:42:00+01:00",
          profile: ["http://hl7.org/fhir/StructureDefinition/Patient"],
        },
        identifier: [
          {
            ...
            system: "https://klinikum-stuttgart.de/fhir/sid/patientId",
            value: "KST-2024-052194",
          },
        ],
    ...
    // NIHSS 14: moderate-severe (0-4 mild, 5-15 moderate, 16-20 moderate-severe, 21-42 severe)
    {
      resource: {
        ...
        code: {
          coding: [
            { system: "http://loinc.org", code: "72107-6", display: "NIH stroke scale score" },
          ],
          text: "NIHSS Score",
        },
            ...
            coding: [
              {
                system: "http://terminology.hl7.org/CodeSystem/v3-ObservationInterpretation",
                code: "H",
                display: "Moderate-severe stroke",
              },
            ],
          },
        ],
        referenceRange: [
          {
            text: "0 = no deficit; 1-4 = minor; 5-15 = moderate; 16-20 = moderate-severe; 21-42 = severe",
          },
        ],
      } as FHIRObservation,
    },
    ...
    // Normal on glucose: rules out hypoglycaemia mimic
    {
      resource: {
        ...
        referenceRange: [
          { low: { value: 4.0 }, high: { value: 6.1 }, unit: "mmol/L", text: "Fasting reference" },
        ],
      } as FHIRObservation,
    },
    // Stroke diagnosis
          ...
          coding: [
            {
              system: "http://hl7.org/fhir/sid/icd-10-gm",
              code: "I63.3",
              display: "Hirninfarkt durch Thrombose zerebraler Arterien",
            },
  ...
  entry: [
    {
      resource: {
        ...
        meta: {
          versionId: "1",
          lastUpdated: "2024-04-08T16:34:00+02:00",
          profile: ["http://hl7.org/fhir/StructureDefinition/Patient"],
        },
        identifier: [
          {
            ...
            system: "https://klinikum-freiburg.de/fhir/sid/patientId",
            value: "KFR-2024-007341",
          },
        ],
        ...
        referenceRange: [
          {
            ...
            text: "Anaphylaxie-Schock < 90 mmHg (WAO Grade III)",
          },
        ],
      } as FHIRObservation,
    },
          ...
          coding: [
            {
              system: "http://hl7.org/fhir/sid/icd-10-gm",
              code: "T78.2",
              display: "Anaphylaktischer Schock, nicht näher bezeichnet",
            },
            {
              system: "http://snomed.info/sct",
              code: "241929008",
              display: "Anaphylactic reaction due to stinging insect",
            },
          ],
  ...
  entry: [
    {
      resource: {
        ...
        meta: {
          versionId: "1",
          lastUpdated: "2024-04-12T07:18:00+02:00",
          profile: ["http://hl7.org/fhir/StructureDefinition/Patient"],
        },
        identifier: [
          {
            ...
            system: "https://klinikum-karlsruhe.de/fhir/sid/patientId",
            value: "KKA-2024-031847",
          },
        ],
        ...
        referenceRange: [
          {
            ...
            text: "ADA Level 1 < 3.9, Level 2 < 3.0 (54 mg/dL), Level 3 (severe) any cognitively impaired",
          },
        ],
      } as FHIRObservation,
    },
    ...
    // Glibenclamide: renal elimination, CI if GFR < 30 (DGIM/DDG 2023)
    {
      resource: {
        ...
        referenceRange: [
          { low: { value: 60, unit: "mL/min/1.73m2" }, text: "CKD Stage 3b (eGFR 30-44)" },
        ],
      } as FHIRObservation,
    },
    {
          ...
          coding: [
            {
              system: "http://hl7.org/fhir/sid/icd-10-gm",
              code: "E11.64",
              display: "Diabetes mellitus, Typ 2: Mit Hypoglykämie: Mit Koma",
            },
        ...
        medicationCodeableConcept: {
          coding: [
            ...
            },
            {
              ...
              code: "A10BB01",
              display: "Glibenclamide (Sulfonylharnstoff)",
            },
          ],
